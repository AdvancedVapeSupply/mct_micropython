 ...
 *
 * Command line:
 * /Users/danielmcshan/GitHub/mct_micropython/lib/lv_bindings/gen/gen_mpy.py -M espidf -MD /Users/danielmcshan/GitHub/mct_micropython/ports/esp32/build-GENERIC_S3_SPIRAM/lv_espidf.c.json -E /Users/danielmcshan/GitHub/mct_micropython/ports/esp32/build-GENERIC_S3_SPIRAM/lv_espidf.c.pp.filtered /Users/danielmcshan/GitHub/mct_micropython/lib/lv_bindings/driver/esp32/espidf.h
 *
...
#include "/Users/danielmcshan/GitHub/mct_micropython/lib/lv_bindings/driver/esp32/espidf.h"
...
STATIC const mp_rom_map_elem_t GPIO_NUM_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR__40), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_40)) },
    { MP_ROM_QSTR(MP_QSTR__41), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_41)) },
    { MP_ROM_QSTR(MP_QSTR__42), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_42)) },
    { MP_ROM_QSTR(MP_QSTR__43), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_43)) },
    { MP_ROM_QSTR(MP_QSTR__44), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_44)) },
    { MP_ROM_QSTR(MP_QSTR__45), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_45)) },
    { MP_ROM_QSTR(MP_QSTR__46), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_46)) },
    { MP_ROM_QSTR(MP_QSTR__47), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_47)) },
    { MP_ROM_QSTR(MP_QSTR__48), MP_ROM_PTR(MP_ROM_INT(GPIO_NUM_48)) },
...
STATIC const mp_rom_map_elem_t PERIPH_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_USB_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_USB_MODULE)) },
    ...
    { MP_ROM_QSTR(MP_QSTR_LCD_CAM_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_LCD_CAM_MODULE)) },
    ...
    { MP_ROM_QSTR(MP_QSTR_SPI2_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_SPI2_MODULE)) },
    { MP_ROM_QSTR(MP_QSTR_SPI3_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_SPI3_MODULE)) },
    ...
    { MP_ROM_QSTR(MP_QSTR_HMAC_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_HMAC_MODULE)) },
    { MP_ROM_QSTR(MP_QSTR_DS_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_DS_MODULE)) },
    { MP_ROM_QSTR(MP_QSTR_RSA_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_RSA_MODULE)) },
    { MP_ROM_QSTR(MP_QSTR_SYSTIMER_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_SYSTIMER_MODULE)) },
    { MP_ROM_QSTR(MP_QSTR_GDMA_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_GDMA_MODULE)) },
    { MP_ROM_QSTR(MP_QSTR_DEDIC_GPIO_MODULE), MP_ROM_PTR(MP_ROM_INT(PERIPH_DEDIC_GPIO_MODULE)) },
...
STATIC const mp_rom_map_elem_t ETS_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_WIFI_MAC_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_WIFI_MAC_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_WIFI_MAC_NMI_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_WIFI_MAC_NMI_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_WIFI_PWR_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_WIFI_PWR_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_WIFI_BB_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_WIFI_BB_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_BT_MAC_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_BT_MAC_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_BT_BB_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_BT_BB_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_BT_BB_NMI_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_BT_BB_NMI_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_RWBT_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_RWBT_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_RWBLE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_RWBLE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_RWBT_NMI_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_RWBT_NMI_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_RWBLE_NMI_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_RWBLE_NMI_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_I2C_MASTER_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_I2C_MASTER_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SLC0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SLC0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SLC1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SLC1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_UHCI0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_UHCI0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_UHCI1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_UHCI1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_GPIO_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_GPIO_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_GPIO_NMI_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_GPIO_NMI_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_GPIO_INTR_SOURCE2), MP_ROM_PTR(MP_ROM_INT(ETS_GPIO_INTR_SOURCE2)) },
    { MP_ROM_QSTR(MP_QSTR_GPIO_NMI_SOURCE2), MP_ROM_PTR(MP_ROM_INT(ETS_GPIO_NMI_SOURCE2)) },
    { MP_ROM_QSTR(MP_QSTR_SPI1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SPI1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SPI2_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SPI2_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SPI3_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SPI3_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_LCD_CAM_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_LCD_CAM_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_I2S0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_I2S0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_I2S1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_I2S1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_UART0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_UART0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_UART1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_UART1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_UART2_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_UART2_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SDIO_HOST_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SDIO_HOST_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_PWM0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_PWM0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_PWM1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_PWM1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_LEDC_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_LEDC_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_EFUSE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_EFUSE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TWAI_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TWAI_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_USB_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_USB_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_RTC_CORE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_RTC_CORE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_RMT_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_RMT_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_PCNT_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_PCNT_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_I2C_EXT0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_I2C_EXT0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_I2C_EXT1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_I2C_EXT1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SPI2_DMA_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SPI2_DMA_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SPI3_DMA_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SPI3_DMA_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_WDT_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_WDT_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TIMER1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TIMER1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TIMER2_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TIMER2_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TG0_T0_LEVEL_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TG0_T0_LEVEL_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TG0_T1_LEVEL_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TG0_T1_LEVEL_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TG0_WDT_LEVEL_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TG0_WDT_LEVEL_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TG1_T0_LEVEL_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TG1_T0_LEVEL_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TG1_T1_LEVEL_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TG1_T1_LEVEL_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_TG1_WDT_LEVEL_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_TG1_WDT_LEVEL_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CACHE_IA_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CACHE_IA_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SYSTIMER_TARGET0_EDGE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SYSTIMER_TARGET0_EDGE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SYSTIMER_TARGET1_EDGE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SYSTIMER_TARGET1_EDGE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SYSTIMER_TARGET2_EDGE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SYSTIMER_TARGET2_EDGE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SPI_MEM_REJECT_CACHE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SPI_MEM_REJECT_CACHE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DCACHE_PRELOAD0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DCACHE_PRELOAD0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_ICACHE_PRELOAD0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_ICACHE_PRELOAD0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DCACHE_SYNC0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DCACHE_SYNC0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_ICACHE_SYNC0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_ICACHE_SYNC0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_APB_ADC_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_APB_ADC_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_IN_CH0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_IN_CH0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_IN_CH1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_IN_CH1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_IN_CH2_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_IN_CH2_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_IN_CH3_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_IN_CH3_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_IN_CH4_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_IN_CH4_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_OUT_CH0_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_OUT_CH0_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_OUT_CH1_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_OUT_CH1_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_OUT_CH2_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_OUT_CH2_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_OUT_CH3_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_OUT_CH3_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_OUT_CH4_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_OUT_CH4_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_RSA_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_RSA_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_AES_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_AES_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_SHA_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_SHA_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_FROM_CPU_INTR0_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_FROM_CPU_INTR0_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_FROM_CPU_INTR1_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_FROM_CPU_INTR1_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_FROM_CPU_INTR2_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_FROM_CPU_INTR2_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_FROM_CPU_INTR3_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_FROM_CPU_INTR3_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_ASSIST_DEBUG_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_ASSIST_DEBUG_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_APBPERI_PMS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_APBPERI_PMS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CORE0_IRAM0_PMS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CORE0_IRAM0_PMS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CORE0_DRAM0_PMS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CORE0_DRAM0_PMS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CORE0_PIF_PMS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CORE0_PIF_PMS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CORE0_PIF_PMS_SIZE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CORE0_PIF_PMS_SIZE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CORE1_IRAM0_PMS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CORE1_IRAM0_PMS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CORE1_DRAM0_PMS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CORE1_DRAM0_PMS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CORE1_PIF_PMS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CORE1_PIF_PMS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CORE1_PIF_PMS_SIZE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CORE1_PIF_PMS_SIZE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_BACKUP_PMS_VIOLATE_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_BACKUP_PMS_VIOLATE_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CACHE_CORE0_ACS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CACHE_CORE0_ACS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_CACHE_CORE1_ACS_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_CACHE_CORE1_ACS_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_USB_SERIAL_JTAG_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_USB_SERIAL_JTAG_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_PERI_BACKUP_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_PERI_BACKUP_INTR_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_DMA_EXTMEM_REJECT_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_DMA_EXTMEM_REJECT_SOURCE)) },
    { MP_ROM_QSTR(MP_QSTR_MAX_INTR_SOURCE), MP_ROM_PTR(MP_ROM_INT(ETS_MAX_INTR_SOURCE)) }
};
...
STATIC MP_DEFINE_CONST_OBJ_TYPE(
    ...
    locals_dict, &ETS_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_ETS_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_ETS_type_base,
};
...
STATIC const mp_rom_map_elem_t RESET_REASON_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_CHIP_BROWN_OUT), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CHIP_BROWN_OUT)) },
    { MP_ROM_QSTR(MP_QSTR_CHIP_SUPER_WDT), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CHIP_SUPER_WDT)) },
    ...
    { MP_ROM_QSTR(MP_QSTR_CPU1_MWDT0), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CPU1_MWDT0)) },
    ...
    { MP_ROM_QSTR(MP_QSTR_CPU0_MWDT1), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CPU0_MWDT1)) },
    { MP_ROM_QSTR(MP_QSTR_CPU1_MWDT1), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CPU1_MWDT1)) },
    { MP_ROM_QSTR(MP_QSTR_SYS_SUPER_WDT), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_SYS_SUPER_WDT)) },
    { MP_ROM_QSTR(MP_QSTR_SYS_CLK_GLITCH), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_SYS_CLK_GLITCH)) },
    { MP_ROM_QSTR(MP_QSTR_CORE_EFUSE_CRC), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CORE_EFUSE_CRC)) },
    { MP_ROM_QSTR(MP_QSTR_CORE_USB_UART), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CORE_USB_UART)) },
    { MP_ROM_QSTR(MP_QSTR_CORE_USB_JTAG), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CORE_USB_JTAG)) },
    { MP_ROM_QSTR(MP_QSTR_CORE_PWR_GLITCH), MP_ROM_PTR(MP_ROM_INT(RESET_REASON_CORE_PWR_GLITCH)) }
};
...
/*
 * espidf ADC_ARB_MODE object definitions
 */
    

STATIC const mp_rom_map_elem_t ADC_ARB_MODE_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_SHIELD), MP_ROM_PTR(MP_ROM_INT(ADC_ARB_MODE_SHIELD)) },
    { MP_ROM_QSTR(MP_QSTR_FIX), MP_ROM_PTR(MP_ROM_INT(ADC_ARB_MODE_FIX)) },
    { MP_ROM_QSTR(MP_QSTR_LOOP), MP_ROM_PTR(MP_ROM_INT(ADC_ARB_MODE_LOOP)) }
};

STATIC MP_DEFINE_CONST_DICT(ADC_ARB_MODE_locals_dict, ADC_ARB_MODE_locals_dict_table);

STATIC void ADC_ARB_MODE_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "espidf ADC_ARB_MODE");
}



STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lv_ADC_ARB_MODE_type_base,
    MP_QSTR_ADC_ARB_MODE,
    MP_TYPE_FLAG_NONE,
    print, ADC_ARB_MODE_print,
    
    
    attr, call_parent_methods,
    
    
    locals_dict, &ADC_ARB_MODE_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_ADC_ARB_MODE_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_ADC_ARB_MODE_type_base,
};
    

/*
 * espidf ADC_DIGI_FILTER object definitions
 */
    

STATIC const mp_rom_map_elem_t ADC_DIGI_FILTER_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_IDX0), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IDX0)) },
    { MP_ROM_QSTR(MP_QSTR_IDX1), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IDX1)) },
    { MP_ROM_QSTR(MP_QSTR_IDX_MAX), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IDX_MAX)) }
};

STATIC MP_DEFINE_CONST_DICT(ADC_DIGI_FILTER_locals_dict, ADC_DIGI_FILTER_locals_dict_table);

STATIC void ADC_DIGI_FILTER_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "espidf ADC_DIGI_FILTER");
}



STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lv_ADC_DIGI_FILTER_type_base,
    MP_QSTR_ADC_DIGI_FILTER,
    MP_TYPE_FLAG_NONE,
    print, ADC_DIGI_FILTER_print,
    
    
    attr, call_parent_methods,
    
    
    locals_dict, &ADC_DIGI_FILTER_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_ADC_DIGI_FILTER_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_ADC_DIGI_FILTER_type_base,
};
    

/*
 * espidf ADC_DIGI_FILTER_IIR object definitions
 */
    

STATIC const mp_rom_map_elem_t ADC_DIGI_FILTER_IIR_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR__2), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IIR_2)) },
    { MP_ROM_QSTR(MP_QSTR__4), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IIR_4)) },
    { MP_ROM_QSTR(MP_QSTR__8), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IIR_8)) },
    { MP_ROM_QSTR(MP_QSTR__16), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IIR_16)) },
    { MP_ROM_QSTR(MP_QSTR__64), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IIR_64)) },
    { MP_ROM_QSTR(MP_QSTR_MAX), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FILTER_IIR_MAX)) }
};

STATIC MP_DEFINE_CONST_DICT(ADC_DIGI_FILTER_IIR_locals_dict, ADC_DIGI_FILTER_IIR_locals_dict_table);

STATIC void ADC_DIGI_FILTER_IIR_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "espidf ADC_DIGI_FILTER_IIR");
}



STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lv_ADC_DIGI_FILTER_IIR_type_base,
    MP_QSTR_ADC_DIGI_FILTER_IIR,
    MP_TYPE_FLAG_NONE,
    print, ADC_DIGI_FILTER_IIR_print,
    
    
    attr, call_parent_methods,
    
    
    locals_dict, &ADC_DIGI_FILTER_IIR_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_ADC_DIGI_FILTER_IIR_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_ADC_DIGI_FILTER_IIR_type_base,
};
    

/*
 * espidf ADC_DIGI_MONITOR object definitions
 */
    

STATIC const mp_rom_map_elem_t ADC_DIGI_MONITOR_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_IDX0), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_MONITOR_IDX0)) },
    { MP_ROM_QSTR(MP_QSTR_IDX1), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_MONITOR_IDX1)) },
    { MP_ROM_QSTR(MP_QSTR_IDX_MAX), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_MONITOR_IDX_MAX)) },
    { MP_ROM_QSTR(MP_QSTR_HIGH), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_MONITOR_HIGH)) },
    { MP_ROM_QSTR(MP_QSTR_LOW), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_MONITOR_LOW)) },
    { MP_ROM_QSTR(MP_QSTR_MAX), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_MONITOR_MAX)) }
};

STATIC MP_DEFINE_CONST_DICT(ADC_DIGI_MONITOR_locals_dict, ADC_DIGI_MONITOR_locals_dict_table);

STATIC void ADC_DIGI_MONITOR_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "espidf ADC_DIGI_MONITOR");
}



STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lv_ADC_DIGI_MONITOR_type_base,
    MP_QSTR_ADC_DIGI_MONITOR,
    MP_TYPE_FLAG_NONE,
    print, ADC_DIGI_MONITOR_print,
    
    
    attr, call_parent_methods,
    
    
    locals_dict, &ADC_DIGI_MONITOR_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_ADC_DIGI_MONITOR_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_ADC_DIGI_MONITOR_type_base,
};
...
STATIC const mp_rom_map_elem_t ADC1_CHANNEL_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR__8), MP_ROM_PTR(MP_ROM_INT(ADC1_CHANNEL_8)) },
    { MP_ROM_QSTR(MP_QSTR__9), MP_ROM_PTR(MP_ROM_INT(ADC1_CHANNEL_9)) },
...
/*
 * espidf I2S object definitions
 */
    

STATIC const mp_rom_map_elem_t I2S_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_CHANNEL_MONO), MP_ROM_PTR(MP_ROM_INT(I2S_CHANNEL_MONO)) },
    { MP_ROM_QSTR(MP_QSTR_CHANNEL_STEREO), MP_ROM_PTR(MP_ROM_INT(I2S_CHANNEL_STEREO)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH0), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH0)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH1), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH1)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH2), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH2)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH3), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH3)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH4), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH4)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH5), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH5)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH6), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH6)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH7), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH7)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH8), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH8)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH9), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH9)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH10), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH10)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH11), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH11)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH12), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH12)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH13), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH13)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH14), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH14)) },
    { MP_ROM_QSTR(MP_QSTR_TDM_ACTIVE_CH15), MP_ROM_PTR(MP_ROM_INT(I2S_TDM_ACTIVE_CH15)) }
};

STATIC MP_DEFINE_CONST_DICT(I2S_locals_dict, I2S_locals_dict_table);

STATIC void I2S_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "espidf I2S");
}
...
STATIC MP_DEFINE_CONST_OBJ_TYPE(
    ...
    locals_dict, &I2S_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_I2S_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_I2S_type_base,
};
...
STATIC const mp_rom_map_elem_t I2S_CHANNEL_FMT_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_MULTIPLE), MP_ROM_PTR(MP_ROM_INT(I2S_CHANNEL_FMT_MULTIPLE)) }
};
...
/*
 * espidf I2S_PCM object definitions
 */
    

STATIC const mp_rom_map_elem_t I2S_PCM_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_DISABLE), MP_ROM_PTR(MP_ROM_INT(I2S_PCM_DISABLE)) },
    { MP_ROM_QSTR(MP_QSTR_A_DECOMPRESS), MP_ROM_PTR(MP_ROM_INT(I2S_PCM_A_DECOMPRESS)) },
    { MP_ROM_QSTR(MP_QSTR_A_COMPRESS), MP_ROM_PTR(MP_ROM_INT(I2S_PCM_A_COMPRESS)) },
    { MP_ROM_QSTR(MP_QSTR_U_DECOMPRESS), MP_ROM_PTR(MP_ROM_INT(I2S_PCM_U_DECOMPRESS)) },
    { MP_ROM_QSTR(MP_QSTR_U_COMPRESS), MP_ROM_PTR(MP_ROM_INT(I2S_PCM_U_COMPRESS)) }
};

STATIC MP_DEFINE_CONST_DICT(I2S_PCM_locals_dict, I2S_PCM_locals_dict_table);

STATIC void I2S_PCM_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "espidf I2S_PCM");
}



STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lv_I2S_PCM_type_base,
    MP_QSTR_I2S_PCM,
    MP_TYPE_FLAG_NONE,
    print, I2S_PCM_print,
    ...
    locals_dict, &I2S_PCM_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_I2S_PCM_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_I2S_PCM_type_base,
};
...
typedef __typeof__( ((lldesc_t*)(0))->qe ) lldesc_qe_t;

/*
 * Struct lldesc_qe_t
 */

STATIC inline const mp_obj_type_t *get_mp_lldesc_qe_t_type();

STATIC inline void* mp_write_ptr_lldesc_qe_t(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_lldesc_qe_t_type()));
    return (lldesc_qe_t*)self->data;
}

#define mp_write_lldesc_qe_t(struct_obj) *((lldesc_qe_t*)mp_write_ptr_lldesc_qe_t(struct_obj))

STATIC inline mp_obj_t mp_read_ptr_lldesc_qe_t(void *field)
{
    return lv_to_mp_struct(get_mp_lldesc_qe_t_type(), field);
}

#define mp_read_lldesc_qe_t(field) mp_read_ptr_lldesc_qe_t(copy_buffer(&field, sizeof(lldesc_qe_t)))
#define mp_read_byref_lldesc_qe_t(field) mp_read_ptr_lldesc_qe_t(&field)

STATIC void mp_lldesc_qe_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(self_in);
    GENMPY_UNUSED lldesc_qe_t *data = (lldesc_qe_t*)self->data;

    if (dest[0] == MP_OBJ_NULL) {
        // load attribute
        switch(attr)
        {
            case MP_QSTR_stqe_next: dest[0] = ptr_to_mp((void*)data->stqe_next); break; // converting from lldesc_t *;
            default: call_parent_methods(self_in, attr, dest); // fallback to locals_dict lookup
        }
    } else {
        if (dest[1])
        {
            ...
            switch(attr)
            {
                case MP_QSTR_stqe_next: data->stqe_next = (void*)mp_to_ptr(dest[1]); break; // converting to lldesc_t *;
                default: return;
            }
...
STATIC void mp_lldesc_qe_t_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "struct lldesc_qe_t");
}

STATIC const mp_obj_dict_t mp_lldesc_qe_t_locals_dict;

STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lldesc_qe_t_type,
    MP_QSTR_lldesc_qe_t,
    MP_TYPE_FLAG_NONE,
    print, mp_lldesc_qe_t_print,
    make_new, make_new_lv_struct,
    binary_op, lv_struct_binary_op,
    subscr, lv_struct_subscr,
    attr, mp_lldesc_qe_t_attr,
    locals_dict, &mp_lldesc_qe_t_locals_dict,
    buffer, mp_blob_get_buffer,
    parent, &mp_lv_base_struct_type
);
...
STATIC inline const mp_obj_type_t *get_mp_lldesc_t_type();

STATIC inline void* mp_write_ptr_lldesc_t(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_lldesc_t_type()));
    return (lldesc_t*)self->data;
}

#define mp_write_lldesc_t(struct_obj) *((lldesc_t*)mp_write_ptr_lldesc_t(struct_obj))

STATIC inline mp_obj_t mp_read_ptr_lldesc_t(void *field)
{
    return lv_to_mp_struct(get_mp_lldesc_t_type(), field);
}

#define mp_read_lldesc_t(field) mp_read_ptr_lldesc_t(copy_buffer(&field, sizeof(lldesc_t)))
#define mp_read_byref_lldesc_t(field) mp_read_ptr_lldesc_t(&field)

STATIC void mp_lldesc_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(self_in);
    GENMPY_UNUSED lldesc_t *data = (lldesc_t*)self->data;
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        switch(attr)
        {
            ...
            case MP_QSTR_length: dest[0] = mp_obj_new_int_from_uint(data->length); break; // converting from uint32_t;
            case MP_QSTR_offset: dest[0] = mp_obj_new_int_from_uint(data->offset); break; // converting from uint32_t;
            case MP_QSTR_sosf: dest[0] = mp_obj_new_int_from_uint(data->sosf); break; // converting from uint32_t;
            case MP_QSTR_eof: dest[0] = mp_obj_new_int_from_uint(data->eof); break; // converting from uint32_t;
            case MP_QSTR_owner: dest[0] = mp_obj_new_int_from_uint(data->owner); break; // converting from uint32_t;
            case MP_QSTR_buf: dest[0] = mp_array_from_u8ptr((void*)data->buf); break; // converting from uint8_t *;
            case MP_QSTR_empty: dest[0] = mp_obj_new_int_from_uint(data->empty); break; // converting from uint32_t;
            case MP_QSTR_qe: dest[0] = mp_read_byref_lldesc_qe_t(data->qe); break; // converting from lldesc_qe_t;
            default: call_parent_methods(self_in, attr, dest); // fallback to locals_dict lookup
        }
    } else {
        if (dest[1])
        {
            ...
            switch(attr)
            {
                ...
                case MP_QSTR_length: data->length = (uint32_t)mp_obj_get_int(dest[1]); break; // converting to uint32_t;
                case MP_QSTR_offset: data->offset = (uint32_t)mp_obj_get_int(dest[1]); break; // converting to uint32_t;
                case MP_QSTR_sosf: data->sosf = (uint32_t)mp_obj_get_int(dest[1]); break; // converting to uint32_t;
                case MP_QSTR_eof: data->eof = (uint32_t)mp_obj_get_int(dest[1]); break; // converting to uint32_t;
                case MP_QSTR_owner: data->owner = (uint32_t)mp_obj_get_int(dest[1]); break; // converting to uint32_t;
                case MP_QSTR_buf: data->buf = (void*)mp_array_to_u8ptr(dest[1]); break; // converting to uint8_t *;
                case MP_QSTR_empty: data->empty = (uint32_t)mp_obj_get_int(dest[1]); break; // converting to uint32_t;
                case MP_QSTR_qe: data->qe = mp_write_lldesc_qe_t(dest[1]); break; // converting to lldesc_qe_t;
                default: return;
            }
...
STATIC void mp_lldesc_t_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "struct lldesc_t");
}

STATIC const mp_obj_dict_t mp_lldesc_t_locals_dict;

STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lldesc_t_type,
    MP_QSTR_lldesc_t,
    MP_TYPE_FLAG_NONE,
    print, mp_lldesc_t_print,
    make_new, make_new_lv_struct,
    binary_op, lv_struct_binary_op,
    subscr, lv_struct_subscr,
    attr, mp_lldesc_t_attr,
    locals_dict, &mp_lldesc_t_locals_dict,
    buffer, mp_blob_get_buffer,
    parent, &mp_lv_base_struct_type
);
...
/*
 * espidf extension definition for:
 * inline static uint32_t lldesc_get_chain_length(lldesc_t *head)
 */

STATIC mp_obj_t mp_lldesc_get_chain_length(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    lldesc_t *head = mp_write_ptr_lldesc_t(mp_args[0]);
    uint32_t _res = ((uint32_t (*)(lldesc_t *))lv_func_ptr)(head);
    return mp_obj_new_int_from_uint(_res);
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lldesc_get_chain_length_mpobj, 1, mp_lldesc_get_chain_length, lldesc_get_chain_length);
    

/*
 * espidf extension definition for:
 * inline static void lldesc_config(lldesc_t *ds, uint8_t owner, uint8_t eof, uint8_t sosf, uint16_t len)
 */

STATIC mp_obj_t mp_lldesc_config(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    lldesc_t *ds = mp_write_ptr_lldesc_t(mp_args[0]);
    uint8_t owner = (uint8_t)mp_obj_get_int(mp_args[1]);
    uint8_t eof = (uint8_t)mp_obj_get_int(mp_args[2]);
    uint8_t sosf = (uint8_t)mp_obj_get_int(mp_args[3]);
    uint16_t len = (uint16_t)mp_obj_get_int(mp_args[4]);
    ((void (*)(lldesc_t *, uint8_t, uint8_t, uint8_t, uint16_t))lv_func_ptr)(ds, owner, eof, sosf, len);
    return mp_const_none;
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lldesc_config_mpobj, 5, mp_lldesc_config, lldesc_config);
...
STATIC mp_obj_t mp_lldesc_num2link(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    lldesc_t *head = mp_write_ptr_lldesc_t(mp_args[0]);
    uint16_t nblks = (uint16_t)mp_obj_get_int(mp_args[1]);
    lldesc_t * _res = ((lldesc_t *(*)(lldesc_t *, uint16_t))lv_func_ptr)(head, nblks);
    return mp_read_ptr_lldesc_t((void*)_res);
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lldesc_num2link_mpobj, 2, mp_lldesc_num2link, lldesc_num2link);
...
STATIC mp_obj_t mp_lldesc_set_owner(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    lldesc_t *head = mp_write_ptr_lldesc_t(mp_args[0]);
    uint16_t nblks = (uint16_t)mp_obj_get_int(mp_args[1]);
    uint8_t owner = (uint8_t)mp_obj_get_int(mp_args[2]);
    lldesc_t * _res = ((lldesc_t *(*)(lldesc_t *, uint16_t, uint8_t))lv_func_ptr)(head, nblks, owner);
    return mp_read_ptr_lldesc_t((void*)_res);
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lldesc_set_owner_mpobj, 3, mp_lldesc_set_owner, lldesc_set_owner);
...
{
    lldesc_t *out_desc_array = mp_write_ptr_lldesc_t(mp_args[0]);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lldesc_setup_link_constrained_mpobj, 5, mp_lldesc_setup_link_constrained, lldesc_setup_link_constrained);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lldesc_get_received_len_mpobj, 2, mp_lldesc_get_received_len, lldesc_get_received_len);
    

STATIC const mp_rom_map_elem_t mp_lldesc_t_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR___SIZE__), MP_ROM_PTR(MP_ROM_INT(sizeof(lldesc_t))) },
    { MP_ROM_QSTR(MP_QSTR_get_chain_length), MP_ROM_PTR(&mp_lldesc_get_chain_length_mpobj) },
    { MP_ROM_QSTR(MP_QSTR_config), MP_ROM_PTR(&mp_lldesc_config_mpobj) },
    { MP_ROM_QSTR(MP_QSTR_num2link), MP_ROM_PTR(&mp_lldesc_num2link_mpobj) },
    { MP_ROM_QSTR(MP_QSTR_set_owner), MP_ROM_PTR(&mp_lldesc_set_owner_mpobj) },
    { MP_ROM_QSTR(MP_QSTR_setup_link_constrained), MP_ROM_PTR(&mp_lldesc_setup_link_constrained_mpobj) },
    { MP_ROM_QSTR(MP_QSTR_get_received_len), MP_ROM_PTR(&mp_lldesc_get_received_len_mpobj) },
    
};

STATIC MP_DEFINE_CONST_DICT(mp_lldesc_t_locals_dict, mp_lldesc_t_locals_dict_table);
        

STATIC const mp_rom_map_elem_t mp_lldesc_qe_t_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR___SIZE__), MP_ROM_PTR(MP_ROM_INT(sizeof(lldesc_qe_t))) },
    
};

STATIC MP_DEFINE_CONST_DICT(mp_lldesc_qe_t_locals_dict, mp_lldesc_qe_t_locals_dict_table);
...
/* Reusing esp_clk_slowclk_cal_set for gpio_pad_select_gpio */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_pad_select_gpio_mpobj, 1, mp_esp_clk_slowclk_cal_set, gpio_pad_select_gpio);
...
STATIC mp_obj_t mp_gpio_pad_set_drv(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    uint32_t drv = (uint32_t)mp_obj_get_int(mp_args[1]);
    ((void (*)(uint32_t, uint32_t))lv_func_ptr)(gpio_num, drv);
    return mp_const_none;
}
...
/* Reusing esp_clk_slowclk_cal_set for gpio_pad_pullup */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_pad_pullup_mpobj, 1, mp_esp_clk_slowclk_cal_set, gpio_pad_pullup);
    
/* Reusing esp_clk_slowclk_cal_set for gpio_pad_pulldown */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_pad_pulldown_mpobj, 1, mp_esp_clk_slowclk_cal_set, gpio_pad_pulldown);
    
/* Reusing esp_clk_slowclk_cal_set for gpio_pad_unhold */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_pad_unhold_mpobj, 1, mp_esp_clk_slowclk_cal_set, gpio_pad_unhold);
    
/* Reusing esp_clk_slowclk_cal_set for gpio_pad_hold */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_pad_hold_mpobj, 1, mp_esp_clk_slowclk_cal_set, gpio_pad_hold);
    
/* Reusing esp_clk_slowclk_cal_set for gpio_pad_input_enable */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_pad_input_enable_mpobj, 1, mp_esp_clk_slowclk_cal_set, gpio_pad_input_enable);
...
/* Reusing gpio_pad_set_drv for gpio_iomux_in */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_iomux_in_mpobj, 2, mp_gpio_pad_set_drv, gpio_iomux_in);
...
STATIC mp_obj_t mp_gpio_force_hold_all(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_force_hold_all_mpobj, 0, mp_gpio_force_hold_all, gpio_force_hold_all);
    
/* Reusing gpio_force_hold_all for gpio_force_unhold_all */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_gpio_force_unhold_all_mpobj, 0, mp_gpio_force_hold_all, gpio_force_unhold_all);
...
/*
 * espidf extension definition for:
 * void lldesc_build_chain(uint8_t *descptr, uint32_t desclen, uint8_t *mblkptr, uint32_t buflen, uint32_t blksz, uint8_t owner, lldesc_t **head, lldesc_t **tail)
 */

STATIC mp_obj_t mp_lldesc_build_chain(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    uint8_t *descptr = mp_array_to_u8ptr(mp_args[0]);
    uint32_t desclen = (uint32_t)mp_obj_get_int(mp_args[1]);
    uint8_t *mblkptr = mp_array_to_u8ptr(mp_args[2]);
    uint32_t buflen = (uint32_t)mp_obj_get_int(mp_args[3]);
    uint32_t blksz = (uint32_t)mp_obj_get_int(mp_args[4]);
    uint8_t owner = (uint8_t)mp_obj_get_int(mp_args[5]);
    lldesc_t **head = mp_to_ptr(mp_args[6]);
    lldesc_t **tail = mp_to_ptr(mp_args[7]);
    ((void (*)(uint8_t *, uint32_t, uint8_t *, uint32_t, uint32_t, uint8_t, lldesc_t **, lldesc_t **))lv_func_ptr)(descptr, desclen, mblkptr, buflen, blksz, owner, head, tail);
    return mp_const_none;
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_lldesc_build_chain_mpobj, 8, mp_lldesc_build_chain, lldesc_build_chain);
...
/* Reusing gpio_force_hold_all for adc_digi_start */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_adc_digi_start_mpobj, 0, mp_gpio_force_hold_all, adc_digi_start);
    
/* Reusing gpio_force_hold_all for adc_digi_stop */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_adc_digi_stop_mpobj, 0, mp_gpio_force_hold_all, adc_digi_stop);
    
/* Reusing gpio_force_hold_all for adc_digi_deinitialize */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_adc_digi_deinitialize_mpobj, 0, mp_gpio_force_hold_all, adc_digi_deinitialize);
...
STATIC inline const mp_obj_type_t *get_mp_i2s_pcm_cfg_t_type();

STATIC inline void* mp_write_ptr_i2s_pcm_cfg_t(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_i2s_pcm_cfg_t_type()));
    return (i2s_pcm_cfg_t*)self->data;
}

#define mp_write_i2s_pcm_cfg_t(struct_obj) *((i2s_pcm_cfg_t*)mp_write_ptr_i2s_pcm_cfg_t(struct_obj))

STATIC inline mp_obj_t mp_read_ptr_i2s_pcm_cfg_t(void *field)
{
    return lv_to_mp_struct(get_mp_i2s_pcm_cfg_t_type(), field);
}

#define mp_read_i2s_pcm_cfg_t(field) mp_read_ptr_i2s_pcm_cfg_t(copy_buffer(&field, sizeof(i2s_pcm_cfg_t)))
#define mp_read_byref_i2s_pcm_cfg_t(field) mp_read_ptr_i2s_pcm_cfg_t(&field)

STATIC void mp_i2s_pcm_cfg_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(self_in);
    GENMPY_UNUSED i2s_pcm_cfg_t *data = (i2s_pcm_cfg_t*)self->data;

    if (dest[0] == MP_OBJ_NULL) {
        // load attribute
        switch(attr)
        {
            case MP_QSTR_pcm_type: dest[0] = mp_obj_new_int(data->pcm_type); break; // converting from i2s_pcm_compress_t;
            default: call_parent_methods(self_in, attr, dest); // fallback to locals_dict lookup
        }
    } else {
        if (dest[1])
        {
            ...
            switch(attr)
            {
                case MP_QSTR_pcm_type: data->pcm_type = (int)mp_obj_get_int(dest[1]); break; // converting to i2s_pcm_compress_t;
                default: return;
            }
...
STATIC void mp_i2s_pcm_cfg_t_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "struct i2s_pcm_cfg_t");
}

STATIC const mp_obj_dict_t mp_i2s_pcm_cfg_t_locals_dict;

STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_i2s_pcm_cfg_t_type,
    MP_QSTR_i2s_pcm_cfg_t,
    MP_TYPE_FLAG_NONE,
    print, mp_i2s_pcm_cfg_t_print,
    make_new, make_new_lv_struct,
    binary_op, lv_struct_binary_op,
    subscr, lv_struct_subscr,
    attr, mp_i2s_pcm_cfg_t_attr,
    locals_dict, &mp_i2s_pcm_cfg_t_locals_dict,
    buffer, mp_blob_get_buffer,
    parent, &mp_lv_base_struct_type
);
...
STATIC mp_obj_t mp_i2s_pcm_config(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    i2s_port_t i2s_num = (int)mp_obj_get_int(mp_args[0]);
    const i2s_pcm_cfg_t *pcm_cfg = (const i2s_pcm_cfg_t *)mp_write_ptr_i2s_pcm_cfg_t(mp_args[1]);
    esp_err_t _res = ((esp_err_t (*)(i2s_port_t, const i2s_pcm_cfg_t *))lv_func_ptr)(i2s_num, pcm_cfg);
    return mp_obj_new_int(_res);
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_i2s_pcm_config_mpobj, 2, mp_i2s_pcm_config, i2s_pcm_config);
    

STATIC const mp_rom_map_elem_t mp_i2s_pcm_cfg_t_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR___SIZE__), MP_ROM_PTR(MP_ROM_INT(sizeof(i2s_pcm_cfg_t))) },
    
};

STATIC MP_DEFINE_CONST_DICT(mp_i2s_pcm_cfg_t_locals_dict, mp_i2s_pcm_cfg_t_locals_dict_table);
...
/* Reusing gpio_pad_set_drv for sntp_set_system_time */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_sntp_set_system_time_mpobj, 2, mp_gpio_pad_set_drv, sntp_set_system_time);
...
/* Reusing gpio_force_hold_all for tcpip_adapter_set_default_eth_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_tcpip_adapter_set_default_eth_handlers_mpobj, 0, mp_gpio_force_hold_all, tcpip_adapter_set_default_eth_handlers);
...
/* Reusing gpio_force_hold_all for tcpip_adapter_clear_default_wifi_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_tcpip_adapter_clear_default_wifi_handlers_mpobj, 0, mp_gpio_force_hold_all, tcpip_adapter_clear_default_wifi_handlers);
    
/* Reusing gpio_force_hold_all for tcpip_adapter_clear_default_eth_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_tcpip_adapter_clear_default_eth_handlers_mpobj, 0, mp_gpio_force_hold_all, tcpip_adapter_clear_default_eth_handlers);
...
/* Reusing gpio_force_hold_all for tcpip_adapter_set_default_wifi_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_tcpip_adapter_set_default_wifi_handlers_mpobj, 0, mp_gpio_force_hold_all, tcpip_adapter_set_default_wifi_handlers);
    
/* Reusing gpio_force_hold_all for esp_netif_init */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_netif_init_mpobj, 0, mp_gpio_force_hold_all, esp_netif_init);
    
/* Reusing gpio_force_hold_all for esp_netif_deinit */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_netif_deinit_mpobj, 0, mp_gpio_force_hold_all, esp_netif_deinit);
...
/* Reusing gpio_force_hold_all for mdns_init */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_mdns_init_mpobj, 0, mp_gpio_force_hold_all, mdns_init);
...
/* Reusing gpio_force_hold_all for mdns_service_remove_all */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_mdns_service_remove_all_mpobj, 0, mp_gpio_force_hold_all, mdns_service_remove_all);
...
STATIC const mp_rom_map_elem_t espidf_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_gpio_pad_input_enable), MP_ROM_PTR(&mp_gpio_pad_input_enable_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_gpio_force_hold_all), MP_ROM_PTR(&mp_gpio_force_hold_all_mpobj) },
    { MP_ROM_QSTR(MP_QSTR_gpio_force_unhold_all), MP_ROM_PTR(&mp_gpio_force_unhold_all_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_lldesc_build_chain), MP_ROM_PTR(&mp_lldesc_build_chain_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_i2s_pcm_config), MP_ROM_PTR(&mp_i2s_pcm_config_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_ETS), MP_ROM_PTR(&mp_lv_ETS_type_base) },
    ...
    { MP_ROM_QSTR(MP_QSTR_ADC_ARB_MODE), MP_ROM_PTR(&mp_lv_ADC_ARB_MODE_type_base) },
    { MP_ROM_QSTR(MP_QSTR_ADC_DIGI_FILTER), MP_ROM_PTR(&mp_lv_ADC_DIGI_FILTER_type_base) },
    { MP_ROM_QSTR(MP_QSTR_ADC_DIGI_FILTER_IIR), MP_ROM_PTR(&mp_lv_ADC_DIGI_FILTER_IIR_type_base) },
    { MP_ROM_QSTR(MP_QSTR_ADC_DIGI_MONITOR), MP_ROM_PTR(&mp_lv_ADC_DIGI_MONITOR_type_base) },
    ...
    { MP_ROM_QSTR(MP_QSTR_I2S), MP_ROM_PTR(&mp_lv_I2S_type_base) },
    ...
    { MP_ROM_QSTR(MP_QSTR_I2S_PCM), MP_ROM_PTR(&mp_lv_I2S_PCM_type_base) },
    ...
    { MP_ROM_QSTR(MP_QSTR_lldesc_t), MP_ROM_PTR(&mp_lldesc_t_type) },
    { MP_ROM_QSTR(MP_QSTR_lldesc_qe_t), MP_ROM_PTR(&mp_lldesc_qe_t_type) },
    ...
    { MP_ROM_QSTR(MP_QSTR_i2s_pcm_cfg_t), MP_ROM_PTR(&mp_i2s_pcm_cfg_t_type) },
