...
#undef MODULE_DEF_MP_QSTR_ESPIDF
#define MODULE_DEF_MP_QSTR_ESPIDF { MP_ROM_QSTR(MP_QSTR_espidf), MP_ROM_PTR(&mp_module_espidf) },
...
#undef MODULE_DEF_MP_QSTR_RTCH
#define MODULE_DEF_MP_QSTR_RTCH { MP_ROM_QSTR(MP_QSTR_rtch), MP_ROM_PTR(&mp_module_rtch) },
